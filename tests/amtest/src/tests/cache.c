...
void clear_cop_csrs() {
    _l1cache_data_write(cop_op_idx, 0);
    _l1cache_data_write(cop_finish_idx, 0);
    _l1cache_data_write(cop_level_idx, 0);
    _l1cache_data_write(cop_way_idx, 0);
    _l1cache_data_write(cop_index_idx, 0);
    _l1cache_data_write(cop_bank_idx, 0);
    _l1cache_data_write(cop_tag_ecc_idx, 0);
    _l1cache_data_write(cop_tag_bits_idx, 0);
    _l1cache_data_write(cop_tag_data_idx, 0);
    _l1cache_data_write(cop_tag_data_h_idx, 0);
    _l1cache_data_write(cop_ecc_width_idx, 0);
    _l1cache_data_write(cop_data_ecc_idx, 0);
