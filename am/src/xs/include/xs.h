...
#if defined(__ARCH_RISCV64_NOOP) || defined(__ARCH_RISCV32_NOOP) || defined(__ARCH_RISCV64_XS) || defined(__ARCH_RISCV64_XS_DUAL) || defined(__ARCH_RISCV64_XS_FLASH) || defined(__ARCH_RISCV64_XS_NOHYPE)
