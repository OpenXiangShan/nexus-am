...
int main()
{
  ...
  // if (test_zbs_result != 0xe4fa9ed0) return 1;

  // long test_zbp_result = test_zbp(args, 128);
  // if (test_zbp_result != 0xbf7dc8c4) return 1;

  // long test_zbe_result = test_zbe(args, 128);
  // if (test_zbe_result != 0xad938c6a) return 1;

  // long test_zbc_result = test_zbc(args, 128);
  // if (test_zbc_result != 0xcdef75a4) return 1;

  // long test_zbr_result = test_zbr(args, 128);
  // if (test_zbr_result != 0x31fc780f) return 1;

  // long test_zbm_result = test_zbm(args, 128);
  // if (test_zbm_result != 0x355a32a3) return 1;
 
  // long test_zbt_result = test_zbt(args, 128);
  // if (test_zbt_result != 0xcef7df02) return 1;

  // long test_zbf_result = test_zbf(args, 128);
  // if (test_zbf_result != 0x3fa35b76) return 1;

  long test_stdc_result = test_stdc(args, 128);
  if (test_stdc_result != 0x5a983d30) return 1;
...
//   fflush(stdout);
//   long test_zbb_result = test_zbb(args, 128);
//   printf(" 0x%08lx %s\n", (long)test_zbb_result, test_zbb_result == 0x90f45e4e ? "OK" : "ERROR");
//   if (test_zbb_result != 0x90f45e4e) return 1;
//   printf("test_zbs ");
//   fflush(stdout);
//   long test_zbs_result = test_zbs(args, 128);
//   printf(" 0x%08lx %s\n", (long)test_zbs_result, test_zbs_result == 0xe4fa9ed0 ? "OK" : "ERROR");
//   if (test_zbs_result != 0xe4fa9ed0) return 1;
//   printf("test_zbp ");
//   fflush(stdout);
//   long test_zbp_result = test_zbp(args, 128);
//   printf(" 0x%08lx %s\n", (long)test_zbp_result, test_zbp_result == 0xbf7dc8c4 ? "OK" : "ERROR");
//   if (test_zbp_result != 0xbf7dc8c4) return 1;
//   printf("test_zbe ");
//   fflush(stdout);
//   long test_zbe_result = test_zbe(args, 128);
//   printf(" 0x%08lx %s\n", (long)test_zbe_result, test_zbe_result == 0xad938c6a ? "OK" : "ERROR");
//   if (test_zbe_result != 0xad938c6a) return 1;
//   printf("test_zbc ");
//   fflush(stdout);
//   long test_zbc_result = test_zbc(args, 128);
//   printf(" 0x%08lx %s\n", (long)test_zbc_result, test_zbc_result == 0xcdef75a4 ? "OK" : "ERROR");
//   if (test_zbc_result != 0xcdef75a4) return 1;
//   printf("test_zbr ");
//   fflush(stdout);
//   long test_zbr_result = test_zbr(args, 128);
//   printf(" 0x%08lx %s\n", (long)test_zbr_result, test_zbr_result == 0x31fc780f ? "OK" : "ERROR");
//   if (test_zbr_result != 0x31fc780f) return 1;
//   printf("test_zbm ");
//   fflush(stdout);
//   long test_zbm_result = test_zbm(args, 128);
//   printf(" 0x%08lx %s\n", (long)test_zbm_result, test_zbm_result == 0x355a32a3 ? "OK" : "ERROR");
//   if (test_zbm_result != 0x355a32a3) return 1;
//   printf("test_zbt ");
//   fflush(stdout);
//   long test_zbt_result = test_zbt(args, 128);
//   printf(" 0x%08lx %s\n", (long)test_zbt_result, test_zbt_result == 0xcef7df02 ? "OK" : "ERROR");
//   if (test_zbt_result != 0xcef7df02) return 1;
//   printf("test_zbf ");
//   fflush(stdout);
//   long test_zbf_result = test_zbf(args, 128);
//   printf(" 0x%08lx %s\n", (long)test_zbf_result, test_zbf_result == 0x3fa35b76 ? "OK" : "ERROR");
//   if (test_zbf_result != 0x3fa35b76) return 1;
//   printf("test_stdc");
//   fflush(stdout);
//   long test_stdc_result = test_stdc(args, 128);
//   printf(" 0x%08lx %s\n", (long)test_stdc_result, test_stdc_result == 0x5a983d30 ? "OK" : "ERROR");
//   if (test_stdc_result != 0x5a983d30) return 1;
