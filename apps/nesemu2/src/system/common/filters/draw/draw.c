...
void draw1x(void *dest_void,u32 destp,void *src_void,u32 srcp,u32 w,u32 h)
{
	u32 x,y;
  u32 *dest = dest_void;
  u32 *src = src_void;
...
void draw2x(void *dest_void,u32 destp,void *src_void,u32 srcp,u32 w,u32 h)
{
	u32 x,y;
...
void draw3x(void *dest_void,u32 destp,void *src_void,u32 srcp,u32 w,u32 h)
{
	u32 x,y;
  u32 *dest = dest_void;
  u32 *src = src_void;
...
void draw4x(void *dest_void,u32 destp,void *src_void,u32 srcp,u32 w,u32 h)
{
	u32 x,y,z;
  u32 *dest = dest_void;
  u32 *src = src_void;
...
void draw5x(void *dest_void,u32 destp,void *src_void,u32 srcp,u32 w,u32 h)
{
	u32 x,y,z;
  u32 *dest = dest_void;
  u32 *src = src_void;
...
void draw6x(void *dest_void,u32 destp,void *src_void,u32 srcp,u32 w,u32 h)
{
	u32 x,y,z;
  u32 *dest = dest_void;
  u32 *src = src_void;
