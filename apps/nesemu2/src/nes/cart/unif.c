...
BLOCKFUNCDECL(ID_MAPR)	{
  char *data = (char *)block->data;
  ret->mapperid = mapper_get_mapperid_unif(data); strcpy(board,data);
}
BLOCKFUNCDECL(ID_NAME)	{	strncpy(ret->title,(char *)block->data,CART_TITLE_LEN);	}
